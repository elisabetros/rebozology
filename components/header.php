...
<body>
    ...
    <nav class="deskmenu">
        ...
        <a href="aboutartisans.php" class="<?php if ($sCurrentPage == 'aboutartisans') echo 'active'; ?>" >The Artisans</a>
        <a href="stories.php" class="<?php if ($sCurrentPage == 'stories') echo 'active'; ?>" >Stories</a>
        <a href="about.php" class="<?php if ($sCurrentPage == 'about') echo 'active'; ?>" >The Founder</a>
        <a href="https://www.rebozology.com/shop" >Shop</a>
        <a href="howto.php" class="<?php if ($sCurrentPage == 'howTo') echo 'active'; ?>" >How to use</a>
        <a href="contact.php" class="<?php if ($sCurrentPage == 'contact') echo 'active'; ?>" >Contact Us</a> 
        <a href="dk/<?= $sCurrentPage !== "frontpage" || $sCurrentPage !== ''?   $sCurrentPage :   "index" ?>">Danish</a>
        </nav>
